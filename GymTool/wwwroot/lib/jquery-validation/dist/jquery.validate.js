...
$.extend( $.validator, {
	...
	messages: {
		...
		email: "Ingresa una direcci&oacute;n de correo v&aacute;lida. ",
		url: "Por favor ingresa una URL v&aacute;lida. ",
		date: "Por favor ingresa una fecha v&aacute;lida. ",
		dateISO: "Por favor ingresa una fecha v&aacute;lida (ISO). ",
		number: "Ingresa un valor numerico v&aacute;lido. ",
		digits: "Por favor ingresa solo d&iacute;gitos. ",
		equalTo: "Por favor ingresa el mismo valor nuevamente. ",
		maxlength: $.validator.format("Por favor ingresa no m&aacute;s de {0} caracteres. "),
		minlength: $.validator.format("Por favor ingresa al menos {0} caracteres."),
		rangelength: $.validator.format("Por favor ingresa una cantidad entre {0} y {1} de caracteres. "),
		...
		step: $.validator.format("Por favor ingresa un m&uacute;ltiplo de {0}. ")
	},
